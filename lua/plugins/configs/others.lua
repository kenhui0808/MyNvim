...
local core_configs = require("core.configs")
...
M.better_escape = function()
  require("better_escape").setup {
    mapping = core_configs.mappings.plugins.better_escape.esc_insertmode,
    timeout = core_configs.plugins.options.esc_insertmode_timeout,
  }
end
...
M.luasnip = function()
  ...
  if present then
    ...
    require("luasnip/loaders/from_vscode").load { paths = core_configs.plugins.options.luasnip.snippet_path }
